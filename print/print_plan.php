...
include_once 'scripts/office_supplies_header.php';
include_once 'scripts/table_a.php';
include_once 'scripts/display_persection.php';
include_once 'scripts/training_supplies.php';
include_once 'scripts/equipment_consumable.php';
include_once 'scripts/non_consumable_per_section.php';
include_once 'scripts/other_common_use.php';
include_once 'scripts/semi_exapandable_equipment_furniture.php';
include_once 'scripts/semi_exapandable_per_section.php';
include_once 'scripts/open_list.php';


$pdf->SetFont('Arial','B',10);
$pdf->Row(array("","\t\t\t\t\t\t\t\t\t\t\t\t","","Grand Total",number_format($grand_total,2),"","",'','','','','','','',''));
