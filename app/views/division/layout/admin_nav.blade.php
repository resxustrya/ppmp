    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="{{ asset('print/consolidate.php?division='.Auth::user()->division.'&section='.Auth::user()->section) }}" target="_blank"><i class="glyphicon glyphicon-print"></i> Print Report</a></li>
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="glyphicon glyphicon-user"></i> {{ DB::table('section')->where('id','=',Auth::user()->section)->first()->short }}<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="javascript:void(0);" onclick="get_current_source_fund(this);" data-link="{{ asset('division/source_fund')}}">SOURCE FUND</a</li>
